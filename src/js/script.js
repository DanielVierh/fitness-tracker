    ...
    try {
        ...
        for (let i = 0; i < exerc_array.length; i++) {
            ...
            try {
                ...
                exerciseName = `${exerc_array[i].name} (${currentSet}/${exerc_array[i].sets}) <span style="margin: 0 10px"> </span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-patch-check-fill" viewBox="0 0 16 16">
